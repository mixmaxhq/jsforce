...
_.extend(OAuth2.prototype, /** @lends OAuth2.prototype **/ {
   ...
   * @param {Callback.<TokenResponse>} [callback] - Callback function
   * @param {Callback.<Request>} [logger] - Logger function that receives request object.
   * @returns {Promise.<TokenResponse>}
   */
  requestToken : function(code, callback, logger) {
    return this._postParams({
   ...
   * @private
   */
  _postParams : function(params, callback, logger = () => {}) {
